...
Please check the Readme in the backup folder. Version 1 of the nr-old-growth application only uses the form servies in the backend folder, the rest service code, frontend and backend code are just placeholders for version 2 if needed in the future.
